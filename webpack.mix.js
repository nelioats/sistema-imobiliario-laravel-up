...
mix.sass(
    ...
    .copyDirectory(
        "resources/views/admin/assets/css/toastr.min.css",
        "public/backend/assets/css/toastr.css"
    )
    ...
    .scripts(
        ["resources/views/admin/assets/js/toastr.min.js"],
        "public/backend/assets/js/toastr.js"
    )
