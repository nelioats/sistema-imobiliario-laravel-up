            ...
            <div class="nav_tabs_content">
                ...
                <input type="hidden" name="property_persist" value="{{old('property')}}">
                        ...
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="radio" name="purpouse" value="sale" {{(old('purpouse') == 'on'? 'checked' : '')}} ><span>Venda</span>
                            </label>

                            <label class="label">
                                <input type="radio" name="purpouse" value="rent" {{(old('purpouse') == 'on'? 'checked' : '')}}><span>Locação</span>
                            </label>
                        </div>
...
$(function(){
    ...
    //=====================================================================================
    //PROPRIETARIO funcoes
    //=====================================================================================
    //criando uma funcao para persistencia dos dados
    //com a funcao podemos chamar ela qualquer momento
            ...
            //=====================================================================================
                ...
                if(response.spouse){
                    ...
                    $('select[name="owner_spouse"]').append($('<option>',{
                        ...
                        //recebemos o valor do old na campo hidden para verificar se existe valor, se ele for diferente de zero, colocamos como selected
                ...
                if(response.companies.length){
                   ...
                   $.each(response.companies, function(key,value){
                        ...
                        text: value.alias_name +' ('+value.document_company +')',
                         //recebemos o valor do old na campo hidden para verificar se existe valor, se ele for diferente de zero e tiver o mesmo id, colocamos como selected
    ...
    function setFieldProperty(response){
        ...
        //se ele for diferente de zero, ou seja, foi selecionado algum proprietario
        //isso acontece no caso do erro no formulario, quando o usuario for tentar submeter, onde o campo proprietario recebe um valor old
